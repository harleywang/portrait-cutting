...
(function ($) {
    $.fn.extend({
        portrait: function (ini) {
            ...
            var par = ini.canvas || { width: 360, height: 270, result: 300 };
            var width = par.width + 276;
            $(this).html('<div class="head-portrait-container" style="width:{9}px"><h3 class="head-portrait-nav">{5}</h3><div class="head-portrait-warp"><div class="head-portrait-tips"><div class="head-portrait-left"><h2 class="head-portrait-left-title">{0}</h2><h3 class="head-portrait-left-tip">{1}</h3></div><div class="head-portrait-right"><h2 class="head-portrait-right-title">{2}</h2><h3 class="head-portrait-right-tip">{3}</h3></div></div><div class="head-portrait"><div class="head-portrait-choose"><input type="file" name="head-portrait-file" accept="image/gif,image/jpeg,image/x-png" id="uploadHolderPortrait" /></div><div class="head-portrait-holder"><div class="head-portrait-light"></div></div><div class="head-portrait-preview"><div class="head-portrait-preview-200"></div><div class="head-portrait-preview-60"></div><div class="head-portrait-preview-40"></div><div class="head-portrait-preview-30"></div><div class="head-portrait-preview-50"></div></div><div class="head-portrait-foot"><input class="head-portrait-reupload" type="button" value="" title="{4}" /></div></div></div><div class="head-portrait-button"><a href="javascript://" class="head-portrait-button-link">{6}</a><input type="button" class="head-portrait-button-save" value="{7}" /><input type="button" class="head-portrait-button-cancel" value="{8}" /> <label class="head-portrait-button-tips"></label></div></div>'.format(
                lang.leftitle,
                lang.leftip,
                lang.rightitle,
                lang.rightip,
            ...
            $('.head-portrait').css({ width: '{0}px'.format(width - 31), height: '{0}px'.format(par.height+50) });
            $('.head-portrait-preview').css({ height: '{0}px'.format(par.height) });
            $('.head-portrait-left').css({ width: '{0}px'.format(par.width) });
            $('.head-portrait-choose,.head-portrait-holder,.head-portrait-file,.head-portrait-light,[name=head-portrait-file]').css({ width: '{0}px'.format(par.width), height: '{0}px'.format(par.height) });
